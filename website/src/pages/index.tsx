...
const githubUrl = 'https://github.com/wuwenrui/liney';
const releaseUrl = 'https://github.com/wuwenrui/liney/releases';
const brewCommand = 'brew update && brew install --cask wuwenrui/tap/liney';
      ...
      <div className={styles.pageShell}>
        ...
        <main className={styles.page}>
          ...
          <section className={styles.siteFooter}>
            ...
            <a href={githubUrl}>github.com/wuwenrui/liney</a>
          </section>
        </main>

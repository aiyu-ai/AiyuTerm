...
Download the latest `.dmg` directly from [GitHub Releases](https://github.com/wuwenrui/liney/releases). Open the `.dmg` and drag Liney into your Applications folder.

...
> AiyuTerm is forked from [Liney](https://github.com/everettjf/liney) by everettjf. Thanks to the original author for the excellent foundation. The project has been renamed from Liney to AiyuTerm.
...
- [Liney](https://github.com/everettjf/liney) by everettjf -- the original open-source terminal workspace app this project is forked from

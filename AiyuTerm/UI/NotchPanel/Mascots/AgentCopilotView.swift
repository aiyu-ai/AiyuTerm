//
// AgentCopilotView.swift
// AiyuTerm
//
// Phase 11.3A — CodeIsland mascot port.
// GitHub Copilot pixel mascot.
//
// Adapted 1:1 from CodeIsland upstream `CopilotView.swift`.
// Only the status enum and environment key are remapped to Aiyu names.
//

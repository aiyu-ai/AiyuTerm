//
// AgentBuddyView.swift
// AiyuTerm
//
// Phase 11.3A — CodeIsland mascot port.
// CodeBuddy cat-astronaut pixel mascot.
//
// Adapted 1:1 from CodeIsland upstream `BuddyView.swift`. All shapes,
// colors, and timing values are preserved. The only changes are:
// - Status enum: upstream `AgentStatus` -> Aiyu `AgentSessionStatus`
// - Env key: `\.mascotSpeed` -> `\.agentMascotSpeed` (speed.timeMultiplier)
//
